/* Question 1: an SQL query to get the firstName, lastName, email, and officeCode of all employees.
...
/* Question 2: an SQL query to get the productName, productVendor, and productLine from the products table.
...
/* Question 3:an SQL query to retrieve the orderDate, shippedDate, status, and customerNumber for the first 10 orders.
